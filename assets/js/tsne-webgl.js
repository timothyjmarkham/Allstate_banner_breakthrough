...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Allstate|Geico|Progressive';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Allstate", value: brandCountsHolder["Allstate"]},
    {x: "Geico", value: brandCountsHolder["Geico"]},
    {x: "Progressive", value: brandCountsHolder["Progressive"]}]
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    clusterCounts = [
    {x: "Allstate", value: thisClusterData["Allstate"]},
    {x: "Geico", value: thisClusterData["Geico"]},
    {x: "Progressive", value: thisClusterData["Progressive"]}
    ]
...
mapSprite.src = "assets/images/Allstate Banner Full Map.png";
